                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={sending}
                        className="w-full btn-primary py-3.5 justify-center disabled:opacity-70 disabled:cursor-not-allowed"
                      >
                        {sending ? (
                          <>
                      ...
                      <p className="text-xs text-center text-gray-400">
                        Seus dados são protegidos. Respondemos em até 2 horas úteis.
                      </p>
                    </form>
                  </>
                )}
