...
export const metadata: Metadata = {
  title: "Sobre a Empresa | Pimenta Embalagens Londrina",
  description:
    "Conheça a Pimenta Embalagens: mais de 25 anos fabricando embalagens e caixas de papelão com qualidade, compromisso e atendimento em todo o Brasil.",
};
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          <div className="text-center mb-14">
            ...
            <h2 className="section-title">O que guia a Pimenta Embalagens</h2>
